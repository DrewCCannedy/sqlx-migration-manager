...
This is the README for your extension "sqlx-migration-manager". After writing up a brief description, we recommend including the following sections.
...
To test running migrations against a "real" database, create a sqlite database at the root path by creating a file named `test.sqlite`.<br>
